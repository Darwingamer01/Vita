...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        setIsLoading(true);
        // Sign in with credentials (accepts any email/password in dev)
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 bg-white dark:bg-slate-900 relative">
                ...
                >
                    ...
                    <div className="w-full">
                        {/* Google Button - full width, real OAuth */}
                        <button
                            onClick={() => signIn('google', { callbackUrl: '/dashboard' })}
                            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border border-gray-200 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-800 hover:border-gray-300 dark:hover:border-slate-600 text-gray-900 dark:text-white font-bold transition-all duration-200"
                        >
